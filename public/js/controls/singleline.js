...
var item = $('<div />').addClass('list-group-item half').text('Singleline');
list.append(item);
...
generateItem(item, function () {
	...
	var control = $('<input />')
				.attr({ type: 'text', id: 'test', name: 'test', class: 'cls-value'})
				.attr({ 'data-width': 150, 'data-value': '', 'data-hint': '', 'placeholder': '', 'data-required': '', 'data-searchable': ''})
				.css({ width: '150px' })
