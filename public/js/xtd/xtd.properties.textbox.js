		...
		this.render = function () {
			...
			return $("<div />").addClass("property-item")
							.append(
								...
								.append(
									$("<input />").attr('id', 'txt_'+this.__id).attr('data-id', this.__id).attr('data-parent-id', this.parent.__id).addClass("property-item-label  form-control").attr("type", "text").val(this._value).bind('input', function () {
