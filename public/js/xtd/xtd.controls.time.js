	...
	XTD.controls.Time = function(definition) {
		...
		this.render = function () {
			return $('<div />').attr('id', 'container_'+this.__id).addClass("item-container")
							...
							.append( 
								$('<div />').addClass('item-control input-group').attr('data-date-format','hh:mm:ss').attr('data-link-field',''+this.__id)
								.append(
									...
									$('<input />').addClass('timepicker_show').attr('id',''+this.__id).attr('size','16').attr('type','text').addClass('form-control')
