		...
		this.render = function () {
			...
			return $("<div />").addClass("property-item")
							.append(
								...
								.append(
									$("<select />").attr('id', 'select'+this.__id).attr('data-id', this.__id).attr('data-parent-id', this.parent.__id).addClass("property-item-label").attr("type", "radio").prop('checked' , this._value.toString() == "true").bind('change', function () {
