...
define('ACCESS_RIGHT_ADD',								0b0000000000010000);
define('ACCESS_RIGHT_REMOVE',						0b0000000000100000);
define('ACCESS_RIGHT_EXECUTE',						0b0000000001000000);
define('ACCESS_RIGHT_ACCESS_ADD',				0b0000000010000000);
define('ACCESS_RIGHT_ACCESS_REMOVE',		0b0000000100000000);

define('ACCESS_MEMBER_NO',								0b0000000000000000);
define('ACCESS_MEMBER_PUBLIC',						0b1000000000000000);
define('ACCESS_MEMBER_GROUP',						0b0100000000000000);
define('ACCESS_MEMBER_SELF',							0b0010000000000000);
//
