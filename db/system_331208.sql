...
-- Dumping data for table xtd_core.glossaries: ~7 rows (approximately)
...
-- Dumping data for table xtd_core.permissions: ~2 rows (approximately)
...
-- Dumping data for table xtd_core.static_contents: ~19 rows (approximately)
...
-- Dumping data for table xtd_datapool.form_datas: ~1 rows (approximately)
...
REPLACE INTO `members` (`id`, `username`, `password`, `code`, `display_name`, `photo`, `email`, `phone`, `status`, `login_ip`, `login_time`, `token`, `created_date`, `created_by`, `last_modified_date`, `last_modified_by`, `concurrent_id`) VALUES
	(3, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'a2f8e04814b8', 'Administrator', '', 'jacky.yiu@mouxidea.com.hk', '852) 62882776', 'ACTIVE', '::1', '2016-12-07 18:31:48', 'bcff2607a1cfb4cbe1c1acfc7169cf9c', '2016-11-01 12:31:36', 0, '2016-12-07 18:31:49', 3, '2016-12-08 01:31:49');
